...
function normalizeRitenutaData(source = {}) {
  return {
    ...
    aliquotaCassa: normalizePanelNumber(source.aliquotaCassa ?? source.aliquota_cassa ?? source.cassaPrevidenziale ?? source.cassa_previdenziale),
    importoCassa: normalizePanelNumber(source.importoCassa ?? source.importo_cassa),
    codiceCassa: normalizePanelText(source.codiceCassa || source.codice_cassa),
