  ...
  if (policy.isPagamentoIncasso) {
    ...
    return {
      ...buildPartiteBehavior({
        ...
        showDocumentPanel: false,
        showIvaPanel: Boolean(policy.ivaPerCassa || policy.isDocumentoIva),
        showRitenute: policy.gestioneRitenute === 'pagamento',
        activeTabs: ['rows', ...(policy.ivaPerCassa || policy.isDocumentoIva ? ['iva'] : []), 'partitario', ...(policy.gestioneRitenute === 'pagamento' ? ['ritenute'] : [])],
        warnings,
        reasons,
      }),
      ...rawFields,
  ...
  if (policy.isMovimentoGenerico && policy.gestionePartitario === 'chiusura') {
    ...
    return {
      ...buildPartiteBehavior({
        ...
        showRitenute: policy.gestioneRitenute === 'pagamento',
        activeTabs: ['rows', ...(policy.ivaPerCassa ? ['iva'] : []), 'partitario', ...(policy.gestioneRitenute === 'pagamento' ? ['ritenute'] : [])],
        warnings,
        reasons,
      }),
      ...rawFields,
  ...
  if (policy.ivaPerCassa) {
    ...
    return {
      ...buildPartiteBehavior({
        ...
        showIvaPanel: true,
        showRitenute: policy.gestioneRitenute === 'pagamento',
        activeTabs: ['rows', 'iva', 'partitario', ...(policy.gestioneRitenute === 'pagamento' ? ['ritenute'] : [])],
        warnings,
        reasons,
      }),
      ...rawFields,
