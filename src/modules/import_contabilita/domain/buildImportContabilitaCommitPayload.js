  ...
  const payload = {
    ...
    accounting: {
      causaleContabile: {
        ...
        tipo_causale: normalizeText(input?.causaleContabile?.tipo_causale || input?.causaleContabile?.tipoCausale) || (direction === 'vendita' ? 'docivanormale' : 'docivanormale'),
        tipoCausale: normalizeText(input?.causaleContabile?.tipoCausale || input?.causaleContabile?.tipo_causale) || (direction === 'vendita' ? 'docivanormale' : 'docivanormale'),
        operazione_gestita: normalizeText(input?.causaleContabile?.operazione_gestita || input?.causaleContabile?.operazioneGestita || input?.causaleContabile?.tipo_documento || input?.causaleContabile?.tipoDocumento) || (direction === 'vendita' ? 'fatturaattiva' : 'fatturapassiva'),
        operazioneGestita: normalizeText(input?.causaleContabile?.operazioneGestita || input?.causaleContabile?.operazione_gestita || input?.causaleContabile?.tipoDocumento || input?.causaleContabile?.tipo_documento) || (direction === 'vendita' ? 'fatturaattiva' : 'fatturapassiva'),
        registro_iva: normalizeText(input?.causaleContabile?.registro_iva || input?.causaleContabile?.registroIva || input?.causaleContabile?.codice_registro_iva) || (direction === 'vendita' ? 'vendite' : 'acquisti'),
        registroIva: normalizeText(input?.causaleContabile?.registroIva || input?.causaleContabile?.registro_iva || input?.causaleContabile?.codice_registro_iva) || (direction === 'vendita' ? 'vendite' : 'acquisti'),
        segno_registro_iva: normalizeText(input?.causaleContabile?.segno_registro_iva || input?.causaleContabile?.segnoRegistroIva) || '+',
        segnoRegistroIva: normalizeText(input?.causaleContabile?.segnoRegistroIva || input?.causaleContabile?.segno_registro_iva) || '+',
      },
      rows: accountingRows,
      totals: {
        debit: totalDebit,
