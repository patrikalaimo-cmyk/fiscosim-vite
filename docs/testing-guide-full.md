# FiscoSim — Testing Guide (Step-by-step)
...
# 9. Regression quick matrix (optional)
...
For architecture details (pipeline phases, models, RPCs), see [technical-manual-developers.md](./technical-manual-developers.md). For operator-facing prose, see [operational-manual-accounting-operators.md](./operational-manual-accounting-operators.md).
