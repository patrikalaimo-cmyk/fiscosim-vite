-- Migration: 20260529130000_fase_3c_fix_guards_partitario_colonna.sql
-- Descrizione: Corregge il riferimento alla colonna inesistente p.conto_soggetto_id nella funzione rpc_get_prima_nota_operation_guards.
