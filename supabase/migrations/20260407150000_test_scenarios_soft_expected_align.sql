-- Allinea expected_results degli scenari E2E predefiniti (a/b/c) alla versione "soft".
-- Idempotente: stesso contenuto di 20260406140000, utile se il DB non era stato aggiornato.
